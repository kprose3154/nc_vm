...
then
    if ! curl -sfL https://raw.githubusercontent.com/kprose3154/nc_vm/main/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/kprose3154/nc_vm/main/lib.sh -o /var/scripts/lib.sh
fi
